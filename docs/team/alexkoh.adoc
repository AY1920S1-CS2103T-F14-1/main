...
*** Modified AB3's _help_ command to launch a condensed version of the User Guide within the app(Pull requests https://github.com[#33], https://github.com[#34])
** Documentation:
*** Updated README Page to be aligned with the app's full release: https://github.com[#14]
*** Wrote About Us Page: https://github.com[#14]
*** Wrote Contact Us Page: https://github.com[#14]
*** Contributed to the User Guide for _home_, _help_, _bookmark_ and _deletebookmark_ commands: https://github.com[#14]
*** Contributed to the Developer Guide for _home_, _help_, _bookmark_ and _deletebookmark_ commands: https://github.com[#14]
** Community:
...
** Tools:
*** Provided assistance with GUI development through expertise with Gluon Scene Builder (https://github.com[#42])
